        ...
        <div class="social-links">
            <a href="#" class="social-link">
                <div class="social-icon">
                    <img src="<?php echo $baseUrl; ?>/images/icons8-whatsapp-50.svg" alt="WhatsApp logo">
                </div>
            ...
            <a href="#" class="social-link">
                <div class="social-icon">
                    <img src="<?php echo $baseUrl; ?>/images/icons8-tiktok-50.svg" alt="TikTok logo">
                </div>
            ...
            <a href="#" class="social-link">
                <div class="social-icon">
                    <img src="<?php echo $baseUrl; ?>/images/icons8-instagram-50.svg" alt="Instagram Logo">
                </div>
            ...
            <a href="#" class="social-link">
                <div class="social-icon">
                    <img src="<?php echo $baseUrl; ?>/images/icons8-email-50.png" alt="Email Logo">
                </div>
