...
<head>
    ...
    <script type="text/javascript">
        ...
        })(window, document, "clarity", "script", "vwql1n6dqz");
    </script>
</head>
<body class="<?php echo isset($_COOKIE['theme']) && $_COOKIE['theme'] === 'dark' ? 'dark-mode' : ''; ?>">
<div class="container">
    <header>
        <div class="logo">Vuyani Magibisela<span>.</span></div>
        ...
        <nav class="desktop-navigation">
            ...
            <a href="#" class="light-mode theme-toggle-icon" id="theme-toggle" aria-label="Toggle theme">
